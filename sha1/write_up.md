...
## Solution
Upon realizing that all I needed was two strings that had the same hash when put through sha1, I just googled "sha1 collision text sample." At this point I saw the following messageA and messageB that had the same sha1 from the following website: https://sha-mbles.github.io/.
...
```
I encoded the file in base 64 through this method:
```python
